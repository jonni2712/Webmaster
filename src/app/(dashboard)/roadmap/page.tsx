...
const roadmapData: RoadmapVersion[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Notifiche email per SSL in scadenza', completed: false },
      { name: 'Notifiche Telegram', completed: false },
      { name: 'Notifiche Slack', completed: false },
      { name: 'Notifiche Discord', completed: false },
      { name: 'Webhook personalizzati', completed: false },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Aggiornamento WordPress core', completed: false },
  ...
  },
  {
    ...
    progress: 0,
    features: [
      { name: 'Report uptime mensile PDF', completed: false },
      { name: 'Grafici storici uptime', completed: false },
      { name: 'Grafici Core Web Vitals', completed: false },
      { name: 'Confronto performance tra siti', completed: false },
      { name: 'Export dati CSV/Excel', completed: false },
    ],
  },
  {
    version: 'v1.4.0',
    ...
    progress: 0,
    features: [
      { name: 'Invito membri al team', completed: false },
      { name: 'Ruoli e permessi granulari', completed: false },
      { name: 'Activity log', completed: false },
      { name: 'Assegnazione siti a membri', completed: false },
      { name: 'Commenti sui siti', completed: false },
    ],
  },
  {
    version: 'v1.5.0',
